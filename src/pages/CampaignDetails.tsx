              ...
              {donators.length > 0 ? (
                donators.map((item: any, i) => (
                  ...
                  >
                    ...
                    text-[16px] text-[#b2b3bd] leading-[26px] break-all"
                    >
                      {i + 1}. {item.donator}
                    </p>
                    <p
                      className="font-epilogue font-normal 
                    text-[16px] text-[#808191] leading-[26px] break-all"
                    >
                      {item.donation} ETH
                    </p>
                  </div>
          ...
          >
            ...
            <div className="mt-[30px]">
              <input
                ...
                leding-[30px] placeholder:text-[#4b5264] rounded-[10px]"
                value={amount}
